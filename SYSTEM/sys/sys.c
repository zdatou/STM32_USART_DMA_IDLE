...
void Stm32_Clock_Init(u32 PLL)
{
	...
	RCC_OscInitStructure.HSEPredivValue=RCC_HSE_PREDIV_DIV5;		//HSE预分频
	
    RCC_OscInitStructure.Prediv1Source = RCC_PREDIV1_SOURCE_PLL2;
	RCC_OscInitStructure.PLL2.PLL2State = RCC_PLL2_ON;
	RCC_OscInitStructure.PLL2.PLL2MUL = RCC_PLL2_MUL8;
